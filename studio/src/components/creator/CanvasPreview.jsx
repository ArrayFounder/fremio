...
const trashIcon = "/create-icon/create-trash.png";
const duplicateIcon = "/create-icon/create-duplicate.png";
const lockIcon = "/create-icon/create-lock.png";
const unlockIcon = "/create-icon/create-unlock.png";
const rotateIcon = "/create-icon/rotate.png";
import {
  CANVAS_WIDTH,
  CANVAS_HEIGHT,
  DEFAULT_ELEMENT_MIN,
...
const ElementContent = forwardRef(
  (
    ...
    if (element.type === "photo") {
      ...
      const slotNumber = slotNumberProp ?? element.data?.slotNumber ?? element.data?.label ?? null;
        ...
        >
          ...
          {typeof slotNumber === 'number' ? (
            <div style={{
              ...
              pointerEvents: "none",
              zIndex: 1,
            }} data-slot-number-container="true">
              <span style={{
        ...
        {sortedElements.map((element) => {
          ...
          return (
            ...
            >
              ...
              <ElementContent
                element={element}
                slotNumber={photoSlotMap[element.id] ?? null}
